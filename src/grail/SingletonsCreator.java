...
public class SingletonsCreator 
{
	...
	static InheritingBridgeScenePainter paintScene;
	...
	public static CommandInterpreter commandInterperterFactory()
	{
		if(command==null)
		{
			command=new CommandInterpreter(scannerFactory(),bridgeSceneFactory());
		}
		return command;
	}
	...
	public static InheritingBridgeScenePainter inheritingBridgeScenePainterFactoryMethod()
	{
		if(paintScene==null)
		{
			paintScene=new InheritingBridgeScenePainter();
		}
		return paintScene;
	}
	...
	public static BridgeSceneController bridgeSceneControllerFactoryMethod()
	{
		if(controller==null)
		{
			controller=new BridgeSceneController(inheritingBridgeScenePainterFactoryMethod());
		}
		return controller;
	}
